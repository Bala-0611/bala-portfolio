...
const gokulPortrait = "/images/hero 2.jpeg";
    ...
    <div id="sidebar-nav-container" className="flex flex-col h-full w-full select-none overflow-y-auto custom-scrollbar-none">
      ...
      <div id="sidebar-portrait-frame" className="w-full h-32 sm:h-36 xl:h-40 bg-neutral-900 relative overflow-hidden flex-shrink-0 border-b-2 border-white/10 group">
        ...
        <img
          ...
          className="w-full h-full object-cover contrast-110 brightness-95 group-hover:scale-105 transition-all duration-700 pointer-events-none"
        />
        ...
        <div className="absolute bottom-3 left-4 z-20">
          <span className="font-mono text-[9px] tracking-[0.25em] text-white/50 uppercase block font-light">CHENNAI, TN</span>
          <span className="font-display font-black text-xs text-white uppercase tracking-wider">Bala Anandan</span>
        </div>
      </div>
